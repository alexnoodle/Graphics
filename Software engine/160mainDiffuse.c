...
void colorPixel(renRenderer *ren, double unif[], texTexture (*tex)[], 
    ...
    rgbz[0] = rgbz[0] * intensity * unif[renUNIFLIGHTR];
    rgbz[1] = rgbz[1] * intensity * unif[renUNIFLIGHTG];
    rgbz[2] = rgbz[2] * intensity * unif[renUNIFLIGHTB];
}
